...
extension of $\ndder$ in the repository docs. Open:
(1) the finite-domain quantified proof theory and its completeness theorem;
(2) the full infinite-domain quantified extension; the emergence layer of the source material
...
\texttt{FiniteFO} (finite-domain quantified first pass),
