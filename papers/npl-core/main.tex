% =========================================================================
% NPL core paper — release v0.7 (2026-08-16).
% v0.7: stable Lean/mathlib release pair; reproducibility gates; artifact and
...
Release v0.7 (August 2026). Results marked [L] are verified in the Lean~4 artifact
...
identical tagged archive will be deposited in a durable public repository;
the real DOI is inserted only after that deposit. \textbf{Toolchain.} Lean 4
