% =========================================================================
% NPL finite-domain quantified paper — release v0.7 (2026-08-16).
...
% v0.7: full flat replay compiler and universal membership-certificate bridge proved.
...
Release v0.7 (August 2026). Companion to \emph{Nullivance Propositional Logic:
...
classical first-order proof systems, including a coinductive framework with a
tableau instance for many-sorted classical logic with equality
...
The identical tagged archive will be deposited in a durable public repository;
the real DOI is inserted only after that deposit. \textbf{Toolchain.}
